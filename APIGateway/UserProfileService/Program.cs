...
var producerCofiguration = new ProducerConfig();
builder.Configuration.Bind("producerconfiguration", producerCofiguration);
builder.Services.AddSingleton<ProducerConfig>(producerCofiguration);
